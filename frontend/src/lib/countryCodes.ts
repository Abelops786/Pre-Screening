// Comprehensive country dial codes with ISO-2 codes (for flag images).
export interface CountryCode { code: string; label: string; iso: string }
...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { code: '+236',  label: 'Central African Rep.', iso: 'cf' },
